...
export type TransportBookingMode = Api.TransportBookingMode;
export type TransportSearchCategory = Api.TransportSearchCategory;
export type TransportVehicleType = Api.TransportVehicleType;
export type CabVehicleType = Api.CabVehicleType;
export type CabPlaceKind = Api.CabPlaceKind;
export type TransportPlace = Camelize<Api.TransportPlaceDto>;
export type TransportSearchQuery = Camelize<Api.TransportSearchQueryDto>;
export type TransportSearchResult = Camelize<Api.TransportSearchResultDto>;
export type MetroLine = Camelize<Api.MetroLineDto>;
export type MetroStation = Camelize<Api.MetroStationDto>;
export type MetroNetworkSummary = Camelize<Api.MetroNetworkSummaryDto>;
export type MetroNetwork = Camelize<Api.MetroNetworkDto>;
export type MetroFareQuery = Camelize<Api.MetroFareQueryDto>;
export type MetroLeg = Camelize<Api.MetroLegDto>;
export type MetroInterchange = Camelize<Api.MetroInterchangeDto>;
export type MetroFare = Camelize<Api.MetroFareDto>;
export type CabPlace = Camelize<Api.CabPlaceDto>;
export type CabPlaces = Camelize<Api.CabPlacesDto>;
export type CabLocationInput = Camelize<Api.CabLocationInputDto>;
export type CabOptionsQuery = Camelize<Api.CabOptionsQueryDto>;
export type CabOption = Camelize<Api.CabOptionDto>;
export type CabSearch = Camelize<Api.CabSearchDto>;
export type TransportQuoteInput = Camelize<Api.TransportQuoteRequestDto>;
export type TransportEndpoint = Camelize<Api.TransportEndpointDto>;
export type TransportDetails = Camelize<Api.TransportDetailsDto>;
